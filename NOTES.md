...
docker buildx build --platform linux/amd64 --tag horologger/lndshell:v0.0.0 --load .

docker buildx build --platform linux/arm64 --tag horologger/lndshell-startos:v0.0.0 --load .
...
```sh
su - alunde
docker pull horologger/lndshell:v0.0.0
...
-e DATABASE_URI="/data/lndshell.db" \
-e COOKIE_SECRET="666" \
-v /home/alunde/lndshell/data:/data \
-v /t4/lnd:/lnd:ro \
-p 8080:8080 \
--name nwc \
-it horologger/lndshell:v0.0.0 
